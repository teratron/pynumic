.. pynumic documentation master file, created by
   sphinx-quickstart on Thu Feb  9 16:40:50 2023.
   You can adapt this file completely to your liking, but it should at least
contain the root `toctree` directive.

Welcome to PyNumic's documentation!
===================================
...
.. |VERSION| image:: https://img.shields.io/pypi/v/pynumic
.. |LICENSE| image:: https://img.shields.io/pypi/l/pynumic
.. |PYVERS| image:: https://img.shields.io/pypi/pyversions/pynumic
.. |PYMAT| image:: https://img.shields.io/pypi/format/pynumic
.. |DD| image:: https://img.shields.io/pypi/dd/pynumic

+----------------+----------------------------------------------------------+
| **Code**       + |BLACK| |ISORT|                                          +
+----------------+----------------------------------------------------------+
| **Docstrings** + |DOCFORMATTER| |NUMPSTYLE|                               +
+----------------+----------------------------------------------------------+
